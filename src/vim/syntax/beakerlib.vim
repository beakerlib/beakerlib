...
syn keyword blServicesKeyword rlServiceStart rlServiceStop rlServiceRestore rlServiceDisable rlServiceEnable rlServiceStatus
syn keyword blrpmKeyword rlCheckRpm rlAssertRpm rlAssertNotRpm rlAssertBinaryOrigin rlCheckMakefileRequires rlCheckRequirements rlGetMakefileRequires rlFetchSrcForInstalled rlRpmDownload rlRpmInstall rlCheckDependencies rlCheckRecommended rlCheckRequired 
syn keyword blMountKeyword rlMount rlCheckMount rlAssertMount rlAnyMounted rlHash rlUnhash
syn keyword blInfoKeyword rlShowPackageVersion rlGetArch rlGetDistroRelease rlGetDistroVariant rlShowRunningKernel rlGetPrimaryArch rlGetSecondaryArch rlGetRecommended rlGetRequired rlGetYAMLdeps rlYash_parse 
...
syn keyword blReleaseKeyword rlIsFedora rlIsRHEL rlIsCentOS rlIsRHELLike rlIsOSVersion rlIsOSLike rlIsOS 
